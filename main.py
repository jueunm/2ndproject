...
attraction_data = {
    "리스본": {
        ...
        <ul>
            <li><b>1일차:</b> 리스본 도착, 숙소 체크인. 오후: 알파마 지구 (성 조르제 성, 전망대) 탐험, 저녁: 파두 공연 관람 및 전통 저녁 식사.</li>
            <li><b>2일차:</b> 벨렘 지구 (제로니무스 수도원, 벨렘 탑, 발견 기념비) 투어. 벨렘에서 유명한 에그 타르트(Pastéis de Belém) 맛보기. 오후: 바이샤-시아두 지구에서 쇼핑 및 자유시간.</li>
            <li><b>3일차:</b> 신트라 당일치기 (페나 궁전, 무어 성, 킨타 다 헤갈레이라). 리스본으로 돌아와 타임아웃 마켓 등에서 식사.</li>
            <li><b>4일차:</b> 리스본 자유 시간 (박물관, 쇼핑 등) 및 출국 준비.</li>
        </ul>
        """
    },
    "포르투": {
        ...
        <ul>
            <li><b>1일차:</b> 포르투 도착, 숙소 체크인. 오후: 리베이라 지구 탐험, 동 루이스 1세 다리 상층부 걷기. 저녁: 강변 레스토랑에서 식사.</li>
            <li><b>2일차:</b> 빌라 노바 드 가이아로 이동하여 포트 와인 셀러 투어 및 시음. 오후: 렐루 서점 방문, 클레리구스 탑 오르기.</li>
            <li><b>3일차:</b> 도루 밸리 당일치기 투어 (포도밭 풍경 감상, 와이너리 방문 및 시음, 도루 강 크루즈).</li>
            <li><b>4일차:</b> 포르투 자유 시간 (볼량 시장, 아줄레주 장식 역 등) 및 출국 준비.</li>
        </ul>
        """
    },
    "알가르베": {
        ...
        "itinerary": """
        <h4>✔️ 알가르베 해변 휴양 3박 4일 코스</h4>
        <ul>
            <li><b>1일차:</b> 파루 공항 도착 후 라고스 이동. 숙소 체크인 후 라고스 구시가지 탐험 및 저녁 식사.</li>
            <li><b>2일차:</b> 폰타 다 피에다드 보트 투어 또는 카약/SUP 체험. 오후: 라고스 주변 해변 (프라이아 도나 아나, 프라이아 카밀로)에서 휴식.</li>
            <li><b>3일차:</b> 베나길 동굴 투어. 인근 아름다운 해변 (프라이아 다 마리냐 등) 방문. 저녁: 해산물 요리 즐기기.</li>
            <li><b>4일차:</b> 자유 시간 (해변 산책, 쇼핑 등) 및 출국 준비.</li>
        </ul>
        """
    },
    "코임브라": {
        ...
        "attractions": [
            ...
            {"name": "산타 크루즈 수도원 (Santa Cruz Monastery)", "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Coimbra_-_Mosteiro_de_Santa_Cruz_-_20150917.jpg/1200px-Coimbra_-_Mosteiro_de_Santa_Cruz_-_20150917.jpg",
        ...
        "itinerary": """
        <h4>✔️ 코임브라 1박 2일 역사 탐방 코스</h4>
        <ul>
            <li><b>1일차:</b> 코임브라 도착, 숙소 체크인. 오후: 코임브라 대학교 (조아니나 도서관 포함) 투어. 구시가지 골목길 산책. 저녁: 전통 레스토랑에서 식사.</li>
            <li><b>2일차:</b> 산타 크루즈 수도원 방문. 몬데고 강변 산책. 오후: 자유 시간 후 다음 도시로 이동.</li>
        </ul>
        """
    },
    "에보라": {
        ...
        "itinerary": """
        <h4>✔️ 에보라 1일 역사 투어 코스</h4>
        <ul>
            <li><b>오전:</b> 에보라 도착. 로마 신전, 에보라 대성당 방문.</li>
            <li><b>오후:</b> 해골 예배당 방문. 에보라 구시가지 골목길과 시장 탐험. 저녁: 알렌테주 지역의 전통 요리 맛보기.</li>
            <li><b>팁:</b> 에보라 주변에는 와이너리가 많으니, 관심 있다면 와이너리 투어를 추가하는 것도 좋습니다.</li>
        </ul>
        """
    },
    "오비두스": {
        ...
        "itinerary": """
        <h4>✔️ 오비두스 반나절 로맨틱 코스</h4>
        <ul>
            <li><b>오전/오후:</b> 오비두스 도착. 성벽 위를 걸으며 마을 전체 조망. 아름다운 골목길을 따라 산책하며 기념품 쇼핑.</li>
            <li><b>팁:</b> 리스본에서 당일치기 여행으로 많이 방문하며, 대중교통으로도 쉽게 접근 가능합니다. 여유롭게 마을의 분위기를 즐겨보세요.</li>
        </ul>
        """
    },
    "아베이루": {
        ...
        "itinerary": """
        <h4>✔️ 아베이루 반나절/1일 베니스 감성 코스</h4>
        <ul>
            <li><b>오전/오후:</b> 아베이루 도착. 몰리세이루 보트 투어를 통해 운하 감상.</li>
            <li><b>점심:</b> 아베이루 전통 해산물 요리 즐기기.</li>
            <li><b>오후:</b> 코스타 노바로 이동하여 줄무늬 집들 구경 및 사진 촬영. 아베이루로 돌아와 오보스 몰레스 맛보기.</li>
            <li><b>팁:</b> 포르투에서 당일치기 여행으로 많이 방문하는 곳입니다.</li>
        </ul>
        """
    }
}
...
if page == "✨ 첫 포르투갈 여행자를 위한 특별 가이드":
    ...
    st.markdown("""
    <p>아래 지도에서 포르투갈의 주요 관광지들을 한눈에 확인하세요. 각 도시에 해당하는 마커를 클릭하거나, 아래 드롭다운 메뉴에서 도시를 선택하면 해당 도시의 상세 정보와 추천 일정을 확인할 수 있습니다.</p>
    """, unsafe_allow_html=True)
    ...
    if selected_city:
        ...
        st.markdown("<h4 class='section-header'>추천 일정</h4>", unsafe_allow_html=True)
        st.markdown(f"""
        <div class="info-box">
            {city_info['itinerary']}
